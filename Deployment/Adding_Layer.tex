...
Adding a layer can be done as follows: \todo[inline]{Give some context about what a layer is}
...
\begin{enumerate}
	...
	\item This leads to a new page where the \lstinline|Store| which contains the layer needs be chosen from a drop down list. If there are no \lstinline|Store|s avaible make sure one was added, see \Fref{sec:addingsource} 
...
\todo[inline]{This might be a good point to reference/show the running example.}
...
\todo[inline]{Some concluding text}