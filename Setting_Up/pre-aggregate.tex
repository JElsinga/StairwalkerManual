...
\todo[inline, size=\small]{I am not sure if this discription is correct. Also i believe there is an eloquenter way to discribe the aggregation process.}
...
The tool is used to create a Pre-Aggregate index for a table with $\textit{n}$ dimensions and a measure/aggregate column. It uses with the following commands:
...
\todo[inline, size=\small]{Maybe this explaination should be extended with more details.}
