...
The result expected in this example can be seen in \Fref{fig:result}. Different colors represent a the number of tweets in a region. The result only shows the highest granularity, it is clear to see in the middle of the image that the most tweets are sent. If this layer was is combined with a map it would be clear that this region is directly above England
