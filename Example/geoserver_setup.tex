...
\begin{enumerate}[resume]
	...
	\item Import the \lstinline|RunningExamplSLD.xml| file by using the \lstinline|Choose File| button then the \lstinline|Upload...| link highlighted in red in \Fref{fig:styleimport}.
...
\begin{minipage}{.45\textwidth}
	\begin{enumerate}[resume]
		...
		\item After the fields in the \lstinline|Data| are filled in, go to the \lstinline|Publishing| tab which. See \Fref{fig:layerpublish}.
